...
type
  ...
  private
    ...
    class procedure SetFormActive(const Value: TForm); static;
    { private declarations }
  protected
    { protected declarations }
  public
    class var FFormActive: TForm;
    class property ActChangeTab: TChangeTabAction read FActChangeTab write SetActChangeTab;
...
class procedure TUtils.SetFormActive(const Value: TForm);
begin
  FFormActive := Value;
end;
